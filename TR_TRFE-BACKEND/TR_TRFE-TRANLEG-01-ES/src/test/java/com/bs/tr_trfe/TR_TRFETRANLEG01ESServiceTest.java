...
/**
 * Test for transaction TR_TRFETRANLEG01ESService
 */
...
@ContextConfiguration(locations = {
		...
		"classpath:/META-INF/spring/TR_TRFE-TRANLEG01ESTest.xml" })
public class TR_TRFETRANLEG01ESServiceTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(TR_TRFETRANLEG01ESServiceTest.class);
	
	@Autowired
	private TR_TRFETRANLEG01ESService transaction;
